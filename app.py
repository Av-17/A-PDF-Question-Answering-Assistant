...
embedding_function = GoogleGenerativeAIEmbeddings(model="models/embedding-001") #genmini embedding
...
if pdf:
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as tmp_file:
        ...
        loader = mypdf.load()
        text_Splitter = RecursiveCharacterTextSplitter(chunk_size = 1000,chunk_overlap = 50)#divided into 1000 chunks
